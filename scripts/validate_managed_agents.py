#!/usr/bin/env python3
"""Validate the Wave 3 managed-agent native compatibility catalog."""
...
CATALOG = ROOT / "distribution" / "managed-agents.json"
EXPECTED_HOSTS = {"github-copilot", "windsurf", "cline", "roo-code", "kilo-code", "aider", "goose", "openhands"}
