<!-- Thanks for contributing to Hypertaks. Please complete all sections. -->
...
- **Authoring environment:** <!-- e.g. Claude Code / Codex / Cursor / human -->
- **Target agent(s) tested:** <!-- e.g. Claude Code, OpenClaw, Hermes -->
...
- [ ] If I bumped the version, every per-agent manifest and `package.json` are in
      sync.
- [ ] The `Validate skill & manifests` CI check passes.
