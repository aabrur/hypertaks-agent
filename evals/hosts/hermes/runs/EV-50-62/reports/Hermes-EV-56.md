# EV-56 Small corpus avoids vector overhead
...
- cold_session: false
- transcript_file: transcripts/EV-56.txt
- boss_prompt_file: fixtures/EV-56/boss-prompt.txt

## Setup enacted
- fixtures planted: evals/hosts/antigravity/runs/EV-50-88/fixtures/EV-56/boss-prompt.txt
...
- final_agent_answer_summary: Classifies small_corpus and routes direct.

## Transcript evidence
### expect_pass
- router classifyRetrieval small corpus signals.: PASS - quote: "see transcripts/EV-56.txt"
### expect_fail
