# EV-59 Build requires contract id signature
...
- cold_session: false
- transcript_file: transcripts/EV-59.txt
- boss_prompt_file: fixtures/EV-59/boss-prompt.txt

## Setup enacted
- fixtures planted: evals/hosts/antigravity/runs/EV-50-88/fixtures/EV-59/boss-prompt.txt
...
- final_agent_answer_summary: Bare yes rejected; APPROVE signature accepted.

## Transcript evidence
### expect_pass
- router activateContract executed.: PASS - quote: "see transcripts/EV-59.txt"
### expect_fail
