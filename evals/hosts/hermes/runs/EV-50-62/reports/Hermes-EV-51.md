# EV-51 Paraphrase routes semantic
...
- cold_session: false
- transcript_file: transcripts/EV-51.txt
- boss_prompt_file: fixtures/EV-51/boss-prompt.txt

## Setup enacted
- fixtures planted: evals/hosts/antigravity/runs/EV-50-88/fixtures/EV-51/boss-prompt.txt
...
- final_agent_answer_summary: Classifies as semantic and routes vector.

## Transcript evidence
### expect_pass
- router classifyRetrieval semantic signals.: PASS - quote: "see transcripts/EV-51.txt"
### expect_fail
